...
class MBTITestSolution {
    //RT
    //CF
    //JM
    //AN
    public String solution(String[] survey, int[] choices) {
        String answer = mbtiResult(survey, choices);
        return answer;
    }
    public String mbtiResult(String[] survey, int[] choices){
        ...
        char m = map.get('R') >= map.get('T') ? 'R' : 'T';
        char b = map.get('C') >= map.get('F') ? 'C' : 'F';
        char t = map.get('J') >= map.get('M') ? 'J' : 'M';
        char i = map.get('A') >= map.get('N') ? 'A' : 'N';
        return result.append(m).append(b).append(t).append(i).toString();
